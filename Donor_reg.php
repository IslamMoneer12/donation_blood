...
?>
    <div class="container" style='margin-top:30px;'>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
						...
						<div class="form-group">
							<label class="control-label text-primary" for="NAME" >اسم المتبرع</label>
							<input type="text" placeholder="فاعل الخير" id="donorName"  name="donorName"  required class="form-control input-sm">
						</div>
						...
						<div class="form-group">
							<label class="control-label text-primary" for="" > أقرب مستشفى للتبرع اليها</label>
							<input type="text" placeholder="ادخل اسم المستشفى" id="donorHospital"   name="donorHospital"  required class="form-control input-sm">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
						 <input id="submit" onclick="donorData();" class="btn btn-primary"  type="button" value="أضف بياناتك" style="margin-left:280px;margin-right:20px" >
		...
		var hospital = document.getElementById("donorHospital").value;
		var contactNo = document.getElementById("donorNo").value;
		var email = document.getElementById("donorEmail").value;
		// Returns successful data submission message when the entered information is stored in database.
		var dataString = 'donorName=' + name + '&donorCity=' + city + '&bloodGroup=' + bloodGroup + '&donor_gender=' + gender + '&donorHospital=' + hospital + '&donorNo=' + contactNo + '&donorEmail=' + email;
		if (name == '' || city == '' || bloodGroup == '' || gender == '' || hospital == '' || contactNo == '' || email == '') {
		alert("أرجو تعبئة جميع المدخلات");
		} else {
		// AJAX code to submit form.
		$.ajax({
		type: "POST",
		url: "inc/donor_reg.php",
		data: dataString,
		cache: false,
